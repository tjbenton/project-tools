    ...
    [
      {
        ...
        `,
        dist: 'test/compile/fixtures/template/css/index.html',
        file: 'index.html',
        language: 'pug',
        locale: null,
        map: '',
        path: 'test/compile/fixtures/template/css/index.html',
        processor: 'template',
        root: 'test/compile/fixtures/template/css',
        src: 'test/compile/fixtures/template/css/index.pug',
        type: 'template',
      },
    ]
    ...
    [
      {
        ...
        `,
        dist: 'test/compile/fixtures/template/data/info.json',
        file: 'info.json',
        language: 'json',
        map: '',
        path: 'test/compile/fixtures/template/data/info.json',
        processor: 'none',
        root: 'test/compile/fixtures/template/data',
        src: 'test/compile/fixtures/template/data/info.json',
        type: 'none',
      },
      {
        code: `<!DOCTYPE html>␊
        ...
        `,
        dist: 'test/compile/fixtures/template/data/json-test.html',
        file: 'json-test.html',
        language: 'pug',
        locale: null,
        map: '',
        path: 'test/compile/fixtures/template/data/json-test.html',
        processor: 'template',
        root: 'test/compile/fixtures/template/data',
        src: 'test/compile/fixtures/template/data/json-test.pug',
        type: 'template',
      },
      {
        code: `<!DOCTYPE html>␊
        ...
        `,
        dist: 'test/compile/fixtures/template/data/partial-test.html',
        file: 'partial-test.html',
        language: 'pug',
        locale: null,
        map: '',
        path: 'test/compile/fixtures/template/data/partial-test.html',
        processor: 'template',
        root: 'test/compile/fixtures/template/data',
        src: 'test/compile/fixtures/template/data/partial-test.pug',
        type: 'template',
      },
    ]
    ...
    [
      {
        ...
        `,
        dist: 'test/compile/fixtures/template/simple/index.html',
        file: 'index.html',
        language: 'pug',
        locale: null,
        map: '',
        path: 'test/compile/fixtures/template/simple/index.html',
        processor: 'template',
        root: 'test/compile/fixtures/template/simple',
        src: 'test/compile/fixtures/template/simple/index.pug',
        type: 'template',
      },
    ]
